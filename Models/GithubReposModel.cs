...
{
    /// <summary>
    /// GithubRepo model from the API returns nested JSON
    /// </summary>
    public class GithubReposModel
    {
        ...
        private RepoData githubUserRepoResult;
        /// <summary>
        /// We want to get the user repo data from the API and return to a nested object
        /// </summary>
        /// <param name="username"></param>
        /// <returns></returns>
        public async Task<RepoData> GetGithubRepoAsync(string username)
        {
            string url = "";
            using (HttpClient client = new HttpClient())
            {
                ...
                using (HttpResponseMessage response = client.GetAsync(url).Result)
                {
                    ...
                    githubUserRepoResult = JsonConvert.DeserializeObject<RepoData>(responseBody);

                    return githubUserRepoResult;
